CREATE TYPE "public"."activity_type" AS ENUM('night_completed', 'night_created', 'member_joined');--> statement-breakpoint
...
CREATE TABLE "mvp_votes" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "mvp_vote_unique" UNIQUE("night_id","voter_id")
);
--> statement-breakpoint
CREATE TABLE "poker_night_participants" (
	...
	"rebuy_total" numeric(10, 2) DEFAULT '0' NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "group_activity" ADD CONSTRAINT "group_activity_group_id_groups_id_fk" FOREIGN KEY ("group_id") REFERENCES "public"."groups"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "group_activity" ADD CONSTRAINT "group_activity_actor_id_user_profiles_id_fk" FOREIGN KEY ("actor_id") REFERENCES "public"."user_profiles"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "mvp_votes" ADD CONSTRAINT "mvp_votes_night_id_poker_nights_id_fk" FOREIGN KEY ("night_id") REFERENCES "public"."poker_nights"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "mvp_votes" ADD CONSTRAINT "mvp_votes_voter_id_user_profiles_id_fk" FOREIGN KEY ("voter_id") REFERENCES "public"."user_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "mvp_votes" ADD CONSTRAINT "mvp_votes_candidate_id_user_profiles_id_fk" FOREIGN KEY ("candidate_id") REFERENCES "public"."user_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
